...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        NSArray * titleArray = @[@"社区圈子",@"社区政务",@"社区服务",@"社区物业",@"环保日历",@"爱心捐赠",@"回收服务",@"社区购物"];
        NSArray * imageNameArray = @[@"communityCircle",@"communityPolitic",@"communityService",@"communityRealEstate",@"EPcalendar",@"loveDonation",@"recycleService",@"communityShop"];
